...
// import real type from mock-data types
...
export function ProductCard({ product }: ProductCardProps) {
  return (
    <div className="bg-transparent flex flex-col sm:flex-row items-center gap-6 p-4 border-t border-b border-black/5">
      ...
      <div className="flex-1 space-y-2">
        ...
        <div className="pt-2 space-y-3">
          ...
          <button className="cursor-pointer text-[10px] bg-[#1A817F] hover:bg-[#156b6a] text-white font-medium px-10 py-2.5 rounded-lg shadow-sm transition-colors outline-none">
            Add to Cart
          </button>
