  ...
  return (
    <section className="px-4 md:px-6 py-12 md:py-16 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
        ...
        <div
          className="flex flex-col p-6 sm:p-8 min-h-[400px] md:h-[657px]"
        ...
        >
          <div className="flex flex-col gap-6 sm:gap-8">
            ...
            <h3
              className={`${microgrammaBold.className} text-2xl sm:text-3xl md:text-[40px] leading-none`}
          ...
          <p
            className="mt-auto text-sm sm:text-base md:text-2xl leading-relaxed md:leading-[40px] pt-6"
        ...
        <div
          className="flex flex-col justify-between p-6 sm:p-8 min-h-[400px] md:h-[657px]"
        ...
        >
          ...
          <p
            ...
            style={{ color: '#484848', fontWeight: 400, letterSpacing: '0.1em', fontFamily: 'var(--font-michroma)' }}
          >
            Obpark brings everything together — VRN-linked cart, vehicle health scores, FASTag recharge, genuine parts with compatibility checks, real-time order tracking, and expert support, all in one platform built specifically for Indian vehicle owners across the country.
          </p>
        </div>
