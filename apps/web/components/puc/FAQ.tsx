...
const faqs = [
    {
        ...
        answer:
            'A Pollution Under Control (PUC) certificate is an official document issued by authorized testing centers certifying that your vehicle emissions comply with national environmental standards.',
    },
    {
        question: 'How long is a PUC Certificate valid?',
        answer:
            'For brand new vehicles, a PUC certificate is valid for 1 year. For older vehicles, PUC certificates must be renewed every 6 months.',
    },
    {
        question: 'Is it mandatory to carry a PUC certificate?',
        answer:
            'Yes, under the Motor Vehicles Act, carrying a valid PUC certificate is mandatory for all vehicles driving on Indian public roads.',
    },
    {
        question: 'What happens if my PUC certificate expires?',
        answer:
            'Driving with an expired PUC certificate can attract a fine of up to ₹10,000 under the Motor Vehicles Amendment Act, along with potential vehicle impounding.',
    },
];
