            ...
            <div className="absolute inset-0 z-10 flex flex-col items-center justify-start pt-12 sm:pt-16 md:pt-20 lg:pt-24 xl:pt-28 px-4 sm:px-6">
                <div className="flex flex-col items-center text-center max-w-4xl w-full">
                    ...
                    <motion.div
                        ...
                        className="mt-3 sm:mt-6 md:mt-8 w-full max-w-[500px] bg-white rounded-xl shadow-[0_8px_30px_rgba(7,76,67,0.1)] p-1.5 sm:p-2 flex items-center border border-gray-100 min-w-0"
                    >
                        {/* IND Badge */}
                        <div className="flex items-center justify-center bg-[#1e2329] rounded-lg px-2.5 sm:px-3.5 h-10 sm:h-[46px] w-[46px] sm:w-[56px] shrink-0 select-none">
                            <div className="flex flex-col items-center justify-center">
                                <div className="text-xs sm:text-base leading-none">🇮🇳</div>
                        ...
                        <input
                            ...
                            className="flex-1 min-w-0 px-2 sm:px-3 py-2 text-[10px] sm:text-xs md:text-sm outline-none text-[#074c43] placeholder-[#8ca49d] uppercase font-bold tracking-wider bg-transparent"
                        ...
                        <button 
                            ...
                            className="bg-[#074c43] hover:bg-[#0a5c52] transition-colors text-white px-3 sm:px-5 h-10 sm:h-[46px] rounded-lg font-bold flex items-center gap-1 sm:gap-2 whitespace-nowrap text-xs sm:text-sm shrink-0 disabled:opacity-50 disabled:pointer-events-none"
                        >
                            Check Details <ArrowRight className="w-3.5 h-3.5 sm:w-4 sm:h-4 shrink-0" />
                        </button>
                    </motion.div>
