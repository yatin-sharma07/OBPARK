...
export default function ContactPage() {
  ...
  const phoneNumber = "+918884774300";
        ...
        >
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-16">
            ...
            <div className="flex flex-col items-center text-center p-6 rounded-3xl border border-gray-100 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] bg-white hover:shadow-md transition-shadow">
              ...
              <a href="tel:+918884774300" className="text-sm font-semibold text-gray-700 hover:text-[#094639] hover:underline transition-colors">
                +91 88847-74300
              </a>
            ...
            <div className="flex flex-col items-center text-center p-6 rounded-3xl border border-gray-100 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] bg-white hover:shadow-md transition-shadow">
              ...
              <a href={`mailto:${email}`} className="text-sm font-semibold text-gray-700 hover:text-[#094639] hover:underline transition-colors">
                {email}
              </a>
