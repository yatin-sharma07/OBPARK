    ...
    <form className="space-y-5">
      ...
      <div>
        ...
        <select
          ...
          className={`${michroma.className} w-full border border-gray-300 rounded-lg px-4 py-3 text-[10px] tracking-[0.05em] bg-white text-[#6E9394]`}
        >
      ...
      {/* Date & Time — only if scheduled for later */}
      {timing === 'later' && (
        <div>
          <label className={`${michroma.className} text-sm text-[#0A3D31] font-medium block mb-2`}>
            Date &amp; Time
